...
void insert_customer(int arrival_time)
{
	...
	printf("Customer %d comes at %d minutes. Service time is %d minutes.\n",
...
int remove_customer()
{
	...
	printf("Customer %d starts service at %d minutes. Wait time was %d minutes.\n",
...
void main()
{
	int a_service_time = 0, b_service_time=0;
	...
	while (clock < duration) {
		...
		// So, take out a customer from the queue and start the service.
			...
			printf("A counter : ");
			a_service_time = remove_customer();
			printf("\n");
		}
		...
		if (b_service_time > 0) b_service_time--;
			...
			printf("B counter : ");
			b_service_time = remove_customer();
			printf("\n");
		}
		printf("\n");
	}
